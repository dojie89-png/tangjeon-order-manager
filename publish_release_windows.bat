...
for /f "usebackq delims=" %%v in (`py %PYVER% -c "print(next(l.split(chr(34))[1] for l in open('order_export_gui.py',encoding='utf-8') if l.startswith('APP_VERSION')))"`) do set APPVER=%%v
set TAG=v%APPVER%
